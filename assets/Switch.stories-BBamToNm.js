import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{r as k,R as b}from"./index-BioFo8Zg.js";import{S as c}from"./Switch-ahSb4iNx.js";import"./index-yBjzXJbu.js";const O={title:"Core/Data Entry/Switch",component:c,tags:["autodocs"],argTypes:{checked:{control:"boolean"},disabled:{control:"boolean"},label:{control:"text"}}},s={args:{checked:!1,disabled:!1,label:"Option"},render:e=>{const[r,n]=k.useState(!!e.checked);return b.useEffect(()=>{n(!!e.checked)},[e.checked]),t.jsx(c,{...e,checked:r,onChange:n})}},a={render:()=>{const[e,r]=k.useState(!1);return t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12},children:[t.jsx(c,{checked:e,onChange:r,label:e?"On":"Off"}),t.jsx(c,{checked:!1,label:"未選取狀態"}),t.jsx(c,{checked:!1,disabled:!0,label:"未選取狀態 / 不可修改"}),t.jsx(c,{checked:!0,label:"選取狀態"}),t.jsx(c,{checked:!0,disabled:!0,label:"選取狀態 / 不可修改"})]})}};var l,o,d,i,h;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    checked: false,
    disabled: false,
    label: 'Option'
