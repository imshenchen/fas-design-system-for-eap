...
}`,...(C=(y=m.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};var R,x,j;f.parameters={...f.parameters,docs:{...(R=f.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => {
    const [open, setOpen] = useState(false);
    const anchorRef = useRef<HTMLButtonElement>(null);
    return <div style={{
...
}`,...(j=(x=f.parameters)==null?void 0:x.docs)==null?void 0:j.source}}};const T=["Default","WithIcons"];export{m as Default,f as WithIcons,T as __namedExportsOrder,O as default};
