...
}`,...(S=(v=a.parameters)==null?void 0:v.docs)==null?void 0:S.source},description:{story:"文字截斷場景：tooltip 顯示完整 email",...(f=(I=a.parameters)==null?void 0:I.docs)==null?void 0:f.description}}};var B,C,D,P,R;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(D=(C=s.parameters)==null?void 0:C.docs)==null?void 0:D.source},description:{story:"Rich：標題 + 內文 + 兩個 action 按鈕",...(R=(P=s.parameters)==null?void 0:P.docs)==null?void 0:R.description}}};var N,A,W,Y,k;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:`{
