import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as o}from"./index-BioFo8Zg.js";import{S as l}from"./Select-BYeIEzn-.js";import"./index-yBjzXJbu.js";import"./Checkbox-DACd6qjG.js";import"./Chip-pMYoEiSs.js";const H={title:"Core/Data Entry/Select",component:l,tags:["autodocs"],argTypes:{style:{control:"select",options:["outlined","underline"]},size:{control:"select",options:["xl","l","m","s","xs"]},labelPosition:{control:"select",options:["top","inline","left"]},multiple:{control:"boolean"},searchable:{control:"boolean"},disabled:{control:"boolean"},readOnly:{control:"boolean"},required:{control:"boolean"}}},a=[{value:"apple",label:"蘋果 Apple"},{value:"banana",label:"香蕉 Banana"},{value:"cherry",label:"櫻桃 Cherry"},{value:"durian",label:"榴槤 Durian"},{value:"elderberry",label:"接骨木 Elderberry"},{value:"fig",label:"無花果 Fig"},{value:"grape",label:"葡萄 Grape"},{value:"honeydew",label:"哈密瓜 Honeydew"},{value:"kiwi",label:"奇異果 Kiwi",disabled:!0},{value:"lemon",label:"檸檬 Lemon"}],n={name:"Single select",render:()=>{const[r,t]=o.useState("");return e.jsx("div",{style:{width:320},children:e.jsx(l,{label:"水果",options:a,value:r,onChange:s=>t(s),placeholder:"請選擇一種水果",helperText:`目前選擇：${r||"(無)"}`})})}},i={name:"Multi select",render:()=>{const[r,t]=o.useState(["apple","cherry"]);return e.jsx("div",{style:{width:420},children:e.jsx(l,{label:"喜歡的水果（可多選）",options:a,value:r,onChange:s=>t(s),multiple:!0,placeholder:"請選擇多種水果",helperText:`已選 ${r.length} 項`})})}},c={name:"Single + searchable",render:()=>{const[r,t]=o.useState("");return e.jsx("div",{style:{width:320},children:e.jsx(l,{label:"搜尋選擇",options:a,value:r,onChange:s=>t(s),searchable:!0,placeholder:"輸入文字搜尋"})})}},d={name:"Multi + searchable",render:()=>{const[r,t]=o.useState([]);return e.jsx("div",{style:{width:480},children:e.jsx(l,{label:"搜尋多選",options:a,value:r,onChange:s=>t(s),multiple:!0,searchable:!0,placeholder:"輸入文字搜尋，勾選加入"})})}},p={name:"Single + searchable + creatable",render:()=>{const[r,t]=o.useState("");return e.jsx("div",{style:{width:360},children:e.jsx(l,{label:"分類（可新增）",options:a,value:r,onChange:s=>t(s),searchable:!0,creatable:!0,placeholder:"輸入搜尋，或新增新分類",helperText:`目前選擇：${r||"(無)"}`})})}},u={name:"Multi + searchable + creatable",render:()=>{const[r,t]=o.useState(["apple"]);return e.jsx("div",{style:{width:480},children:e.jsx(l,{label:"標籤（可多選 + 新增）",options:a,value:r,onChange:s=>t(s),multiple:!0,searchable:!0,creatable:!0,placeholder:"輸入搜尋，或新增新標籤",helperText:`已選 ${r.length} 項`})})}},h={name:"All states",render:()=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,width:720},children:[e.jsx(l,{label:"Empty",options:a,placeholder:"請選擇"}),e.jsx(l,{label:"Filled",options:a,defaultValue:"banana"}),e.jsx(l,{label:"Error",options:a,defaultValue:"apple",error:"欄位格式不正確"}),e.jsx(l,{label:"Disabled",options:a,defaultValue:"grape",disabled:!0}),e.jsx(l,{label:"Read-only",options:a,defaultValue:"fig",readOnly:!0}),e.jsx(l,{label:"Underline",options:a,style:"underline",defaultValue:"cherry"})]})},b={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12,width:320},children:[e.jsx(l,{size:"xl",options:a,placeholder:"XL"}),e.jsx(l,{size:"l",options:a,placeholder:"L"}),e.jsx(l,{size:"m",options:a,placeholder:"M (default)"}),e.jsx(l,{size:"s",options:a,placeholder:"S"}),e.jsx(l,{size:"xs",options:a,placeholder:"XS"})]})};var S,v,m;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'Single select',
  render: () => {
...
}`,...(R=(F=d.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};var w,C,U;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(U=(C=p.parameters)==null?void 0:C.docs)==null?void 0:U.source}}};var I,M,z;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
