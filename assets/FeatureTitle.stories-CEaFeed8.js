import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{R as g}from"./index-BioFo8Zg.js";import{B as u}from"./Button-iDd4ESB6.js";import"./index-yBjzXJbu.js";const i={secondary:"var(--secondary)",bgSurface:"var(--bg-surface)",textHigh:"var(--text-high)",divider:"var(--divider)"},n={2:"8px",4:"16px",6:"24px"},G={sticky:10},t=g.forwardRef(({items:q,actions:p,className:E,topOffset:$=56},V)=>{const m=q.slice(0,5);return e.jsxs("div",{ref:V,className:["fas-feature-title",E].filter(Boolean).join(" "),style:{position:"sticky",top:$,zIndex:G.sticky,display:"flex",alignItems:"center",gap:n[4],minHeight:"56px",padding:`${n[2]} ${n[6]}`,backgroundColor:i.bgSurface,borderBottom:`1px solid ${i.divider}`,boxSizing:"border-box"},children:[e.jsx("nav",{"aria-label":"Page breadcrumb",className:"fas-feature-title__nav",style:{display:"flex",alignItems:"center",gap:n[2],flex:1,minWidth:0},children:m.map((d,f)=>{const a=f===m.length-1,P=!a&&!!d.onClick;return e.jsxs(g.Fragment,{children:[P?e.jsx("button",{type:"button",onClick:d.onClick,className:"fas-feature-title__crumb fas-feature-title__crumb--link",style:{font:"inherit",fontSize:"20px",lineHeight:"24px",fontWeight:500,fontFamily:'"Noto Sans TC", sans-serif',color:i.secondary,background:"none",border:"none",padding:0,cursor:"pointer",whiteSpace:"nowrap",textDecoration:"none"},children:d.label}):e.jsx("span",{className:`fas-feature-title__crumb${a?" fas-feature-title__crumb--current":""}`,"aria-current":a?"page":void 0,style:{fontSize:"20px",lineHeight:"24px",fontWeight:500,fontFamily:'"Noto Sans TC", sans-serif',color:a?i.textHigh:i.secondary,whiteSpace:"nowrap",overflow:a?"hidden":void 0,textOverflow:a?"ellipsis":void 0},children:d.label}),!a&&e.jsx("span",{className:"fas-feature-title__sep","aria-hidden":"true",style:{fontFamily:'"Material Icons"',fontSize:"24px",lineHeight:"24px",color:i.secondary,userSelect:"none",flexShrink:0},children:"navigate_next"})]},f)})}),p&&e.jsx("div",{className:"fas-feature-title__actions",style:{display:"flex",alignItems:"center",gap:n[4],flexShrink:0},children:p})]})});t.displayName="FeatureTitle";t.__docgenInfo={description:"",methods:[],displayName:"FeatureTitle",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"FeatureTitleItem"}],raw:"FeatureTitleItem[]"},description:`麵包屑導航層級，最多 5 層。
...
Breadcrumb rule:
  ...
  ❌  Alert Mgmt > Rule Settings > Create  (parent section — not the selected item)`}}}},r={render:()=>e.jsx(t,{topOffset:0,items:[{label:"Rule Settings",onClick:()=>{}},{label:"Create Rule"}],actions:e.jsxs(e.Fragment,{children:[e.jsx(u,{variant:"outlined",color:"secondary",size:"s",children:"Cancel"}),e.jsx(u,{variant:"contained",size:"s",children:"Create"})]})})},s={render:()=>e.jsx(t,{topOffset:0,items:[{label:"Node Management"}]})},l={render:()=>e.jsx(t,{topOffset:0,items:[{label:"Rule Settings",onClick:()=>{}},{label:"Rule Detail",onClick:()=>{}},{label:"Edit"}],actions:e.jsxs(e.Fragment,{children:[e.jsx(u,{variant:"outlined",color:"secondary",size:"s",children:"Cancel"}),e.jsx(u,{variant:"contained",size:"s",children:"Save"})]})})},o={render:()=>e.jsx(t,{topOffset:0,items:[{label:"Alert List",onClick:()=>{}},{label:"Alert Detail"}]})},c={render:()=>e.jsx(t,{topOffset:0,items:[{label:"Storage",onClick:()=>{}},{label:"Bucket List",onClick:()=>{}},{label:"Bucket Detail",onClick:()=>{}},{label:"File List",onClick:()=>{}},{label:"File Detail"}]})};var b,v,x,h,y;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(x=(v=r.parameters)==null?void 0:v.docs)==null?void 0:x.source},description:{story:`Create / edit page — actions placed in FeatureTitle (edit pages only).
SideMenu active item: "Rule Settings" → first breadcrumb level.`,...(y=(h=r.parameters)==null?void 0:h.docs)==null?void 0:y.description}}};var S,k,C,F,R;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <FeatureTitle topOffset={0} items={[{
...
SideMenu active item: "Rule Settings" → first breadcrumb level.`,...(_=(B=l.parameters)==null?void 0:B.docs)==null?void 0:_.description}}};var M,L,z,D,O;o.parameters={...o.parameters,docs:{...(M=o.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => <FeatureTitle topOffset={0} items={[{
    label: 'Alert List',
    onClick: () => {}
  }, {
...
}`,...(z=(L=o.parameters)==null?void 0:L.docs)==null?void 0:z.source},description:{story:`Detail / read-only page — no actions in FeatureTitle.
